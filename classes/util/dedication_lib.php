...
class dedication_manager {
    ...
    public function get_students_dedication($students) {
        ...
        foreach ($students as $user) {
            ...
            $logs = dedication_utils::get_events_select($where, $params);
    ...
    public function download_students_dedication($rows) {
        ...
        return dedication_utils::generate_download("{$this->course->shortname}_dedication", $rows);
    }
...
class dedication_utils {
    ...
    public static function format_ips($ips) {
        return implode(', ', array_map('dedication_utils::link_ip', $ips));
    }
